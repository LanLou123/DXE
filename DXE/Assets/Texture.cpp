...
Texture::Texture(const std::wstring& filename) : Filename(filename), textureID(-1) {

}


Texture::Texture(const std::wstring& filename, UINT64 _textureID) : Filename(filename), textureID(_textureID){
...
RenderTexture::RenderTexture(UINT _width, UINT _height, DXGI_FORMAT _format) : Texture(), width(_width), height(_height){
